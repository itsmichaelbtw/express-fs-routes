...
// //     const tree = await createDirectoryTree(resolvedDirectory, onFile);
...
// //                     if (routeSchema.absolute_path.startsWith(resolvedFilePath)) {
...
// //         modifier: (path: RouteSchema, routeOptions: RouterOptions) => RouteSchema
// //     ): RouteRegistry {
// //         const baseSchema: RouteSchema = {
// //             method: null,
// //             absolute_path: fileEntry.path,
// //             route_options: {},
// //             status: null,
// //             base_path: null,
// //             extended_path: null,
...
// //     async function onFile(fileEntry: DirectoryEnsemble): Promise<void> {
// //         // turn the file into a
// //         // try {
// //         //     const requireHandler: RouteHandler = await import(
// //         //         ensureLeadingToken(fileEntry.path, "file://")
// //         //     );
