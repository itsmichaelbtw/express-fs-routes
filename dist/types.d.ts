...
declare type Methods = "checkout" | "copy" | "delete" | "get" | "head" | "lock" | "merge" | "mkactivity" | "mkcol" | "move" | "m-search" | "notify" | "options" | "patch" | "post" | "purge" | "put" | "report" | "search" | "subscribe" | "trace" | "unlock" | "unsubscribe";
declare type NotImplementedCallback = (req: Request, res: Response) => void;
export declare type FilePath = string;
export declare type TreeComponentType = "file" | "directory";
export declare type DirectoryCallback = Function;
export declare type DirectoryEnsemble = DirTree;
/**
